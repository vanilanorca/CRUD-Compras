...
export class CardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.http.get<any>(`https://crud-commentary-data.herokuapp.com/informacoes/`, {headers: this.headers}).subscribe(res => {
      this.arr = res;
    })
  }
  ...
  deletarCompra(item:any){
    this.http.delete<any>(`https://crud-commentary-data.herokuapp.com/informacoes/${item.id}`, {headers: this.headers}).subscribe(res => {
        this.arr = res
